...
This directory contains evidence-led reviews that sit before architecture or implementation decisions.
...
**Field Evidence → TOP Review → Architecture Impact Assessment → Derived Issues → Canon / Knowledge / Product / Engineering**
